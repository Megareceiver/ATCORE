...
if ($selected_id != -1)
{
	...
	if ($dim == 2)
		$th = array(_("Post"), _("Account/Tax Type"), _("Amount"), _("Department"), _("Department")." 2", "", "");
	elseif ($dim == 1)	
		$th = array(_("Post"), _("Account/Tax Type"), _("Amount"), _("Department"), "", "");
	else	
	...
	if ($dim >= 1) 
		dimensions_list_row(_("Department").":", 'dimension_id', null, true, " ", false, 1);
	if ($dim > 1) 
