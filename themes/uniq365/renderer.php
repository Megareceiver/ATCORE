            ...
            foreach ($applications as $app) {
                if ($app->id != 'Dashboard') {
                    ...
                    if( $dashboard_uri=="products/dashboard"
                        ...
                        if( !isset($tagetDB['reg_number']) ){
                            $tagetDB['reg_number'] = NULL;
                        }
                        echo '<li class="dropdownWithHref a" ><a target="_blank" href="http://xersolution.com/'.$tagetDB['reg_number'].'" ><img src="' . $this->theme_img_uri . '/menuicon_03.png" ><span>HRM</span></a></li>';
                    }
                }
            }
