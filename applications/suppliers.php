...
class suppliers_app extends application
{
	function suppliers_app()
	{
		...
		$this->add_lapp_function(0, _("Purchase Orders"),
			"purchasing/inquiry/po_search_completed.php?", 'SA_SUPPTRANSVIEW', MENU_INQUIRY);
		//$this->add_lapp_function(0, _("GRN on Purchase Orders"),
		//	"#", 'SA_GRN', MENU_TRANSACTION);
		//$this->add_lapp_function(1, _("&Outstanding Purchase Orders Maintenance"),
...
// 		$this->add_lapp_function(0, _("Direct &GRN"), "purchasing/po_entry_items.php?NewGRN=Yes", 'SA_GRN', MENU_TRANSACTION);
		$this->add_lapp_function(0, _("Direct &GRN"), "purchasing/inquiry/supplier_inquiry.php?filtertype=6", 'SA_GRN', MENU_TRANSACTION);
...
// 		$this->add_lapp_function(0, _("Direct &Invoice"),"purchasing/po_entry_items.php?NewInvoice=Yes", 'SA_SUPPLIERINVOICE', MENU_TRANSACTION);
		$this->add_lapp_function(0, _("Direct &Invoice"), "purchasing/inquiry/supplier_inquiry.php?filtertype=1", 'SA_SUPPLIERINVOICE', MENU_TRANSACTION );

		$this->add_rapp_function(0, _("Supplier &Invoices"),"purchasing/inquiry/supplier_inquiry.php?filtertype=2", 'SA_SUPPLIERINVOICE', MENU_TRANSACTION);
		...
		if( defined('COUNTRY') && COUNTRY==60 ){
		    $this->add_lapp_function(0, _("Bad Debt Processing"), "admin/bad_deb.php?type=supplier");
		}
...
// 		$this->add_rapp_function(1, _("Supplier and Purchasing &Reports"), "reporting/reports_main.php?Class=1", 'SA_SUPPTRANSVIEW', MENU_REPORT);
		...
		$this->add_lapp_function(1, _("Check Transactions"),
		    "index.php/purchases/inquiry/check", 'SA_SALESALLOC', MENU_INQUIRY);
...
// 			"reporting/reports_main.php?Class=1&REP_ID=202", 'SA_CUSTOMER', MENU_ENTRY);
		...
		$this->add_lapp_function(4, _("&Suppliers Maintenance"),"purchasing/manage/suppliers.php?", 'SA_SUPPLIER', MENU_ENTRY);
