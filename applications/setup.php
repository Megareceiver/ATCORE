...
class setup_app extends application
{
	function setup_app()
	{
	    $mobile_document = config_ci('mobile_document');
	    $kastam = config_ci('kastam');
...
// 		}
		if( $mobile_document ){
		    $this->add_rapp_function(0, _("Expense Type"),"index.php/admin/expense-type", 'SA_PRINTPROFILE', MENU_MAINTENANCE);
		    $this->add_rapp_function(0, _("Revenue Type"),"index.php/admin/revenue-type", 'SA_PRINTPROFILE', MENU_MAINTENANCE);
		}
...
// 		$this->add_rapp_function(2, _("Install/Activate &Extensions"), "admin/inst_module.php?", 'SA_CREATEMODULES', MENU_MAINTENANCE);
		...
		$this->add_lapp_function(3, _("System GL Accounts"),"admin/opening_balance.php?type=gl", 'SA_VIEWPRINTTRANSACTION', MENU_MAINTENANCE);
		$this->add_lapp_function(3, _("Inventory"),"admin/opening.php?type=inventory", 'SA_VOIDTRANSACTION', MENU_MAINTENANCE);
		$this->add_lapp_function(3, _("Customer"),"maintenance/opening/customer", 'SA_VOIDTRANSACTION', MENU_MAINTENANCE);
		$this->add_lapp_function(3, _("Supplier"),"maintenance/opening/supplier", 'SA_VOIDTRANSACTION', MENU_MAINTENANCE);
