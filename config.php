...
$js_path = '//8ohhpmlevbpjbg02wa3.xersolution.com/';
$assets_path = '//8ohhpmlevbpjbg02wa3.xersolution.com/';



if( !defined('COMPANY_ASSETS') ) {
    define('COMPANY_ASSETS', '//companyasset.accountanttoday.net/'.$session->checkSubDirectory() );
}
...
if( !defined('AT_ASSEETS') ) {
    define('AT_ASSEETS', '//'.$_SERVER['SERVER_NAME'].'/atcore/assets/');
    define('COUNTRY', 60);
}
$js_path = AT_ASSEETS;
