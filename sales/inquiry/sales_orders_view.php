...
echo "<div class='btnadd'><a href='".site_url('sales/sales_order_entry.php?NewQuotation=Yes')."' class='ajaxsubmit'>
<img height='12' src='".site_url('/themes/template/images/ok.gif')."'>Add new</a></div>";


if ($trans_type == ST_SALESORDER)
{
	if (isset($_POST['order_view_mode']))
echo "<div class='btnadd' ><a href='".site_url('sales/sales_order_entry.php?NewOrder=Yes')."' class='ajaxsubmit'>
<img height='12' src='".site_url('themes/template/images/ok.gif')."'>Add new</a></div>";
		//echo '<div style="text-align:right; margin-bottom:10px;"><a href="http://localhost/at2612/sales/sales_order_entry.php?NewOrder=Yes" class="btn btn-success add">Add New</a></div>';
}
