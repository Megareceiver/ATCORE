...
//     bug('tax='.$_SESSION['Items']->tax_total_dispatch);
//     bug($inv_items_total+$_SESSION['Items']->tax_total_dispatch);
...
// submit('ProcessCredit', _("Process Credit Note"), true, '',false);
