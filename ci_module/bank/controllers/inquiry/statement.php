...
class BankInquiryStatement  {
    ...
    function index(){
//         get_instance()->smarty->registerPlugin('function', 'exchange_money', "BankInquiryStatement::smarty_exchange_money" );
//         add_js('js/table.js');
        page("Bank Statement");
        $this->statement();
...
//         $this->filters['bank_account']['value'] = 2;
//         $this->filters['date_from']['value'] = '31-05-2016'; //begin_month()
//         $this->filters['date_to']['value'] = '30-09-2016'; //begin_month()
...
//         $this->db->where('b.type <>',ST_BANKTRANSFER);
