...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	if (!ini_get('date.timezone')) ini_set('date.timezone', 'Europe/Berlin');
...
// standard external js scripts included in all files
$js_static = array(
    'js/jquery-min.1.9.1.js','js/jquery-ui.js','js/mask/min.js',
    'js/JsHttpRequest.js', 'js/behaviour.js', 'js/utils.js', 'js/inserts.js',
    'plugin/air-datepicker/datepicker.js',
    'plugin/air-datepicker/navigation.js',
    'plugin/air-datepicker/body.js',
    'js/ajax_common.js'
);

$css_static = array('plugin/air-datepicker/css/datepicker.css','css/at-style-100126.css','css/bootstrap_custome.css');
// additional js source included in header
$js_lib = $css_lib = $js_userlib = array();

$assets_path = '//'.$_SERVER['HTTP_HOST'].'/atcore/assets/';
