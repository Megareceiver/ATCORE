...
$after_date = date2sql(input_val('BeforeDate'));
$display_location = !$_POST['StockLocation'];

$result = get_stock_movements($_POST['stock_id'], input_val('StockLocation'),
	input_val('BeforeDate'), input_val('BeforeDate'));
...
$before_qty = get_stock_movements_before($_POST['stock_id'], $_POST['StockLocation'], input_val('BeforeDate'));
