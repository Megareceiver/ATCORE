...
//                 ." ". $account['account_name'] ."</a>";
            $url = anchor("/gl/inquiry/gl_account_inquiry.php?TransFromDate=" . $from . "&TransToDate=" . $to . "&Dimension=" . $dimension . "&Dimension2=" . $dimension2 . "&account=" . $account['account_code'] , $account['account_name']);
...
// 				. "&AccGrp=" . $type ."'>" . $type . " " . $typename ."</a>";
			...
			$url = anchor("/gl/inquiry/balance_sheet.php?TransFromDate="
				. $from . "&TransToDate=" . $to . "&Dimension=" . $dimension . "&Dimension2=" . $dimension2
...
// 						. "&AccGrp=" . $accounttype['id'] ."'>" . $accounttype['id']." ".$accounttype['name'] ."</a>";
					...
					$url = anchor("/gl/inquiry/balance_sheet.php?TransFromDate="
						. $from . "&TransToDate=" . $to . "&Dimension=" . $dimension . "&Dimension2=" . $dimension2
						. "&AccGrp=" . $accounttype['id'], $accounttype['id']." ".$accounttype['name']);
					alt_table_row_color($k);
					label_cell($url);
...
// 			."&Compare=0'>"._('Calculated Return')."</a>";
		$url = anchor("/gl/inquiry/profit_loss.php?TransFromDate="
				. $from."&TransToDate=".$to . "&Dimension=" . $dimension . "&Dimension2=" . $dimension2 ."&Compare=0"
		    ,_('Calculated Return'));
