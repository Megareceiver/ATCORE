...
class renderer
{
    ...
    {
        global $assets_path;
        $this->theme_uri = '//' . $_SERVER['HTTP_HOST'] . '/themes/smartledger';
        $this->theme_img_uri = '//' . $_SERVER['HTTP_HOST'] . '/themes/smartledger/images';
            ...
            foreach ($applications as $app) {
                if ($app->id != 'Dashboard') {
                    ...
                    if( $dashboard_uri=="products/dashboard"
                        ...
                        echo '<li class="dropdownWithHref a" ><a target="_blank" href="http://xersolution.com/'.$user.'" ><img src="' . $this->theme_img_uri . '/menuicon_03.png" ><span>HRM</span></a></li>';
                    }
                }
            }
