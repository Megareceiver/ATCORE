...
//---------------
if( defined('COUNTRY') && COUNTRY== 60 AND $kastam){
    table_section_title(_("Company GST Registration Date"));

    echo $ci->finput->inputtaxes('Default GST Code:','gst_default_code',input_val('gst_default_code'),'2,3','row');
...
//     text_row(_("Work Order Required By After:"), 'default_workorder_required', $_POST['default_workorder_required'], 6, 6, '', "", _("days"));
    ...
    text_row(_("Simplified Invoice:"), 'maximum_claimable_input_tax', input_val('maximum_claimable_input_tax'));
