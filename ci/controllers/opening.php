...
// 	                die("do write_opening bank_account_default=$bank_account_default");
	...
	var $inv_fields =array(
		...
		'name'=>array('type'=>'text','title'=>'Product Name','size'=>30,'attr'=>'class="prodname "'),
		'cost'=>array('type'=>'number','title'=>'Opening Cost<br>(Base Curr)','size'=>12),
		'qty'=>array('type'=>'number','title'=>'Opening QTY','size'=>12),
		'total'=>array('type'=>'text','title'=>'Valuation </br>(Base curr)','size'=>12,'attr'=>'class="number " disabled'),
	);
