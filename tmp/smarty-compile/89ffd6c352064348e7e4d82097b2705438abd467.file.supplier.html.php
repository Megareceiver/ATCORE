<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-08-24 15:14:07
         compiled from "E:\xampp\htdocs\atcore\ci\views\bad-deb\supplier.html" */ ?>
<?php /*%%SmartyHeaderCode:4838599e7cbfa95e77-23949391%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89ffd6c352064348e7e4d82097b2705438abd467' => 
    array (
      0 => 'E:\\xampp\\htdocs\\atcore\\ci\\views\\bad-deb\\supplier.html',
      1 => 1456125670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4838599e7cbfa95e77-23949391',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_599e7cc11d4082_90262857',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_599e7cc11d4082_90262857')) {function content_599e7cc11d4082_90262857($_smarty_tpl) {?>
<div class="row">
		...
		<span id="datedeb">
			...
			<?php } else { ?>
				<span class="form-control inputdate">
					<input class="monthpicker date" name='date' type="month" value="<?php echo $_smarty_tpl->tpl_vars['date']->value;?>
" />
				</span>
			<?php }?>
		...
		<div class="col-md-2 form-horizontal" role="form">
...
"  style="width: 80px !important; ">
	  	...
	  	<div class="col-md-5 form-group2">
			<span class="input-group-addon" id="sizing-addon1">Supplier</span>
			<?php echo form::formInput(array('type'=>'SUPPLIER','name'=>'supplier','all'=>true,'value'=>$_smarty_tpl->tpl_vars['supplier']->value),$_smarty_tpl);?>
</div>
	  	<div class="col-md-1">
                    <button type="submit" class="ajaxsubmit">Load Overdue Invoices</button>
                </div>
...
" ajax=false >Process</button>
			...
			<td><?php if ($_smarty_tpl->tpl_vars['tran']->value->process) {
